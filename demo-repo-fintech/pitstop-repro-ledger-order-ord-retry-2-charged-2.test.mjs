// ==============================================================================
// OpenPitStop permanent repro test — finding ledger-46f2bb8e
// Linked from .pitstop/scan-latest.json (issue / cluster finding id ledger-46f2bb8e).
//
...
//
// Run via: npx openpitstop repro ledger-46f2bb8e
...
test("pitstop repro ledger-46f2bb8e: exactly one gateway charge for key '" + EXPECTED_KEY + "'", async () => {
  assert.ok(PRELOAD, "PITSTOP_LEDGER_PRELOAD not set — run this via `npx openpitstop repro ledger-46f2bb8e`");
